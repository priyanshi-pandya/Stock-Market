...
if(!isset($_SESSION['user_email_address'])){
    if(!isset($_SESSION['login_id'])){
        $_SESSION['current_page'] = $_SERVER['REQUEST_URI'];
        header("Location: account.php?dfd");
        exit();
    }
}
...
?>
			...
			"<input type='hidden' name='code' value='<?php echo $row["course_id"]; ?>'>
			<input type='hidden' name='des' value='<?php echo $row["description"]; ?>'>
			<input type='hidden' name='cname' value='<?php echo $row["course_name"]; ?>'>
			<input type='hidden' name='service' value="workshop">
			 <h6 class='text-t my-3 name'> <?php echo $row['course_name']; ?></h6>
			 <h5 class='loc-pr my-3 price'> <input type='hidden' name='cprice' value='<?php echo $row["course_price"]; ?>'>  <?php echo $row['course_price']; ?></h5>
			 <input type="submit" class='btn btn-danger btn-lg btn-block' name="add" value="Add to cart" >
			  <!--<a href='cart.php?id=<?php //echo $id.'&name='."wrkshop" ?>' class='btn btn-danger btn-lg btn-block'>Add to Cart</a>-->
		...
		<div class="col-md-1">
             ...
             <div class="col-md-4 " style="width:auto; height:600px; margin:0; padding:0;">  
