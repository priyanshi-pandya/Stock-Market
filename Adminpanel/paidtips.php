...
<body>
    ...
    ?>
      ...
      <!-- Paid Tips Wall Table -->

      
      <!-- PHP FETCH ALL Paid TIPS -->

      <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <center><h4 class="card-title"><big><u>Available Paid Tips</u></big> </h4></center>
...
<div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                <center><h4 class="card-title"><big><u>Add a Paid Tip</u></big> </h4></center>
                  <form class="form-sample" action="addpaidtip.php" method="POST">
