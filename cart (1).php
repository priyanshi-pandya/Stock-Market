...
?>
 ...
 <script type="text/javascript">
        ...
        function redirectTo(name) {
            ...
            if(name == "mentor"){    
                window.location = "mentorship.php";
            }
        }
 </script>
              ...
              <tbody>
                ...
                <tr>
                      <th scope="row">
                        ...
                        <td class="align-middle"><strong><?php echo $price; ?></strong></td>
                        <td class="border-0 align-middle">  
                        <?php $name=$_GET['name'];
                        //echo $name;   ?>
                            <button onclick="redirectTo('<?php echo $name;  ?>')"  class="text-dark"><i class="fa fa-trash"></i></button>
                        </td>
