            ...
            <div class="rs-breadcrumbs bg-2">
                <div class="container">
                    <div class="content-part text-center">
                        <h1 class="breadcrumbs-title white-color mb-0">Pricing</h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-16">
                            <div class="service-wrap">
                                <div class="icon-part">
                                    ...
                                    <img src="assets/images/services/icons/modify/<?php echo $i; ?>.png" alt="">
                                </div>
                                <div class="content-part">
                                    ...
                                    <div class="desc mb-30 mt-30"><?php echo $row['description'];?></div>
                                     <h5 class="loc-pr  "><?php echo  "₹".$row['price'];?></h5> </h5>
                                     <?php
                                     $lnk = "https://writesoft.co.in/Perfecthit/";
                                     ?>
                                    <a href= <?php echo $row['link']; ?>  class="btn btn-primary">Get Started </a >
