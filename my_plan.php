...
.cart{
    ...
    <body class="home-three">
        ...
        <!--Full width header End-->
                        ...
                        <div class="rs-breadcrumbs bg-2">
                            <div class="container">
                                <div class="content-part text-center">
                                    <h1 class="breadcrumbs-title white-color mb-0">PLANS</h1>
                                </div>
                            </div>
                        </div>
                    </div>
         ...
         <!-- ACTIVE CARDS START HERE    -->
         
        <div class="sec-title mb-20">
                <h2 class="title mt-5 ml-5">ACTIVE PLANS</h2>
        </div>
         ...
         <div class="row">
             <?php
                $indexexp = 0;
                 ...
                 $sql="SELECT * from sub_workshop where login_id = $loginid";
                 $result = mysqli_query($conn, $sql);  
                ...
                foreach($result as $row){
                        ...
                        if($expiry > $curdate && $row['a_deleted'] == 0)
                        {
                            $indexexp = 1;
                        ?>
                        <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                                <div class="card ml-50" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Date of Subscription:- <?php $dt = new DateTime($row['date']);
                                                $date = $dt->format('d M Y'); echo $date;?></p>
                                    <p class="card-text">Expiry date:- <?php $dt = new DateTime($row['expiry']);
                                                $date = $dt->format('d M Y'); echo $date;?></p>
                ...
                <?php
                $sql="SELECT * from sub_paidtip where login_id = $loginid;";
                $result = mysqli_query($conn, $sql);  
                foreach($result as $row){
                $expiry = date('Y-m-d', strtotime($row['expiry']));
                        $curdate = date('Y-m-d');
                      ...
                      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Paid Tips</h5>
                                    <p class="card-text">Date of Enroll:- <?php $dt = new DateTime($row['date']);
                                                $date = $dt->format('d M Y'); echo $date;?></p>
                                    <p class="card-text">Expiry date:- <?php $dt = new DateTime($row['expiry']);
                                                $date = $dt->format('d M Y'); echo $date;?></p>       
                                    <a href="#" class="btn btn-primary">Check</a>
                ...
                <?php }} ?> 
                    ...
                    <?php
             $sql="SELECT * from sub_mentorship where login_id = $loginid;";
                $result = mysqli_query($conn, $sql);  
                foreach($result as $row){
                      $expiry = date('Y-m-d', strtotime($row['expiry']));
                      ...
                      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                            <div class="card ml-50" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Date of Enroll:- <?php $dt = new DateTime($row['date']);
                                                $date = $dt->format('d M Y'); echo $date;?></p>
                                    <p class="card-text">Expiry date:- <?php $dt1 = new DateTime($row['expiry']);
                                                $date1 = $dt1->format('d M Y'); echo $date1;?></p>       
                    ...
                    if($indexexp == 0){
                        echo '<h5 class="font-weight-light col-lg-10 offset-lg-1" style="margin-left: 37%;">All Active Plans will appear here!!</h5>';
                    }
                    ?>
            </div>        
        <!-- ACTIVE CARDS END HERE -->





         <!-- EXPIRED CARDS START HERE -->
         
        <div class="sec-title mb-20">
                <h2 class="title mt-5 ml-5">EXPIRED PLANS</h2>
        </div>
         ...
         <div class="row">
                ...
                foreach($result as $row){
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Expired on:- <?php $dt = new DateTime($row['expiry']);
                                                $date = $dt->format('d M Y'); echo $date;?></p>
                                    
                                     
                                    <!--<a href="#" class="btn btn-primary">RENEW1</a>-->
                                </div>
                                </div>
                    </div>
                      ...
                      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                            <div class="card ml-50" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Deleted by Admin</p>
                                    
                
                                    <!--<p class="card-text">Expired on:- <?php //$dt = new DateTime($row['exipry']);-->
                                                //$date = $dt->format('d M Y'); echo $date;?>  <!--</p>   -->
                                    <?php  //} ?>            
            ...
            <?php    }}   ?>
                ...
                $expiry = date('Y-m-d', strtotime($row['expiry']));
                      ...
                      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Expirer on:- <?php $dt = new DateTime($row['expiry']);
                                                $date = $dt->format('d M Y'); echo $date;?></p>       
                ...
                <?php  }}  ?>     
                    ...
                    if($indexone == 0){
                        echo '<h5 class="font-weight-light col-lg-10 offset-lg-1" style="margin-left: 37%;">All Expired Plans will appear here!!</h5>';
                    }
                    ?>
            </div>        
        <!-- EXPIRED CARDS END HERE -->





        <!-- SUBSCRIBE CARDS START HERE -->
        <div class="sec-title mb-20">
                            <h2 class="title mt-5 ml-5">SUBSCRIBE OUR OTHER PLANS</h2>
        </div>
            ...
            <?php
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Subscribe to our workshop sessions</p>
                                    <a href="workshop.php" class="btn btn-primary">Check</a>
                                </div>
                                </div>
                </div>
              <?php }}?> 
             <?php
                ...
                {?>
                      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Paid Tips</h5>
                                    <p class="card-text">Subscribe to tip and get daily tip</p>
                ...
                <?php }?> 
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Get Personal Mentorship</p>
                                    <a href="mentorship.php" class="btn btn-primary">Check</a>
                                </div>
                                </div>
                    </div> 
        </div>
        <!-- SUBSCRIBE CARDS END HERE -->
