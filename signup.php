                        ...
                        <div class="col-lg-7">
                            <div class="regi-side">
                                ...
                                <form class="register-form" id="register-form" method="POST" action="Loginpage/signupdb.php">
                                    ...
                                    <label>
                                        <input class="checkbox" type="checkbox" name="agreement" required=""> I agree the User Agreement and <a href="#">Terms &amp; Conditions.</a>
                                    </label>

                                    <div class="submit-btn">
                                        <button class="readon" name="signupsubmit" type="submit">Create Account</button>
                                    </div><br>
                                    <center><label class="input-label" id="result" style="color:red;font-weight:400"><?php
                                    if(isset($_GET['error']))
                                    {
                                    ...
                                    <center><p>Already have an account ? <a href="login.php"><u>Log In</u></a></p></center>
                                </form>
                            </div>
                        </div>
