...
<head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Mentorship Deatils</title>
...
?>
        ...
        <?php
            ...
            $id = $_GET['id'];
            $qry = "select * from mentorship where mentorship_id=$id";
            $rs = mysqli_query($conn, $qry);
            $row = $rs->fetch_assoc();
    
        ?>
        
        <div class="cart_div" style="float:right">
            <a href="cart.php?id=<?php echo $id; ?>"><img src="assets/images/cart-icon.png" /> Cart<span><?php echo $carts; ?></span></a>
        </div>
		...
		<div class="col-md-6 ">    
			...
			<input type="hidden" name="service" value="mentor">
			<input type="hidden" name="des" value="<?php echo $row['description'];  ?>">
			<input type="hidden" name="code" value="<?php echo $row['mentorship_id'];  ?>">
			<input type="hidden" name="mprice" value='<?php echo $row["mentorship_price"];  ?>'>
			<input type="hidden" name="mname" value='<?php echo $row["mentorship_topic"];  ?>'>
			 <h6 class="text-t my-3"><?php echo $row['mentorship_topic']; ?></h6>
			 <h5 class="loc-pr my-3"><?php echo $row['mentorship_price'];  ?></h5>
			 <input type="submit" class="btn btn-danger btn-lg btn-block" value="Add to cart" name="add">
			 <!--<a href = "cart.php?id=<?php // echo $_GET['id'].'&name='."mentor";?>" class="btn btn-danger btn-lg btn-block">Add to cart</a>-->
		</div>
        ...
        <div class="col-md-5" style="height:600px; width:auto; margin:0; padding:0; ">
            <h1 class="text-teal"><?php echo $row['mentorship_topic']; ?></h1>
